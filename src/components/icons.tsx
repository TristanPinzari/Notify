...
export function ChevIcon({ size = 14 }: { size?: number } = {}) {
  return (
    <svg
      width={size}
      height={size}
...
export function InspectIcon() {
  return (
    ...
    >
      ...
      <path d="M11.5 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h8l4 4v4" />
      <circle cx="16.5" cy="17.5" r="2.5" />
      <path d="m21 22-2.1-2.1" />
    </svg>
  );
}
...
export function MembersIcon({ size = 13 }: { size?: number } = {}) {
  return (
...
export function ChevronExtIcon() {
  return (
    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ext">
...
export function DocEmptyIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--line-strong)" }}>
...
export function UnbanIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
...
export function CrownIcon({ size = 11 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 18h20M3 6l5 5 4-7 4 7 5-5-2 12H5z" />
    </svg>
  );
}

export function ShieldIcon({ size = 11 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function SunRaysIcon({ size = 16 }: { size?: number } = {}) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
