...
export type ActivityPayload =
  ...
  | { action: "member_left" }
  | { action: "member_kicked"; target: MemberRef; actor: MemberRef }
  | { action: "member_banned"; target: MemberRef; actor: MemberRef }
  | { action: "member_unbanned"; target: MemberRef; actor: MemberRef }
...
export function logActivity(
  ...
  triggerNotifications(classId, payload, topicId).catch((e) =>
